...
<h2>Recursos</h2>
<center>
	<p><a href="<?=$PATH?>admin/loans">Ver Prestamos</a></p>
...
<table>
	<thead>
		<tr class="blank">
			<td colspan="20">
				<a href="<?=$PATH?>admin/resource/new"><i class="icon-new"></i> Crear Nuevo Recurso</a>
			</td>
		</tr>
		<tr>
			<th>Nombre</th>
...
?>
		<tr>
    		...
    		<td><a href="<?=$PATH?>admin/resource/<?=$resource['id']?>/loan/new">Prestar</a></td>
    		<td><a href="<?=$PATH?>admin/resource/<?=$resource['id']?>/contents">Ver Contenidos</a></td>
    		<td><a href="<?=$PATH?>admin/resource/show/<?=$resource['id']?>">Ver Información</a></td>
            <?php
				if( checkAuth('authLevel','1','boolean') ){
			?>
			<td><a href="<?=$PATH?>admin/resource/edit/<?=$resource['id']?>">Editar</a></td>
            <?php
				}
