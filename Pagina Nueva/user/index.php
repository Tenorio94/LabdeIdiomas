...
?>
<?  if ($_GET['groupId']) { ?>
<a href="<?=$PATH?>admin/groups"><< Volver a Lista de Grupos</a>
<?  } ?>
<? if ($_GET['groupId']) { ?>
...
<?  if (checkAuth('authLevel','2','boolean')) { ?>
        <tr class="blank">
            <td colspan="20">
    <a href="<?=$PATH?>admin/<?=$route?>/new"><i class="icon-new"></i> <?if(!$_GET['groupId']) {?>Crear Nuevo Usuario (No Estudiante)<?} else {?>Agregar Estudiante<?}?></a>
            </td>
        </tr>
<? } ?>
		<tr>
...
<?  if (count($users)) {
		...
		<tr>
            ...
            <td><a href="<?=$PATH?>admin/<?=$route?>/show/<?=$user['id']?>">Ver Informaci&oacute;n</a></td>
<?          if (checkAuth('authLevel','2','boolean')) { ?>
<?              if (!$_GET['groupId']) { ?>
