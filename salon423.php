 ...
 function getReservacionPorHora($hora, $dia, $mes)
{
	...
	$reservacion_query = mysql_query("SELECT matricula FROM tbl_reservaciones WHERE dia = $dia and hora = $hora and salon = 422 and mes = '$mes'", $idiomas) or die(mysql_error());
