				...
				<table width="1000px">
					<tbody><tr><td>
								<ul id='menu2' style="width:1000px ">
									...
									<li><a href='index.php?p=busqueda' style="width:75px;">Búsqueda</a></li>
