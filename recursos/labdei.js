  ...
  strMat = document.form3.mat.value;
   ...
   var Char;
      ...
      if (ValidChars.indexOf(Char) == -1) 
         {
         	IsNumber = false;
  			alert("S�lo se aceptan n�meros en la matr�cula (Sin espacios)");
	  ...
	  if(strMat < 100000)
	  {
	  		alert("La matr�cula no es valida");
			document.form3.mat.focus();
	  }
...
function valida()
{
	...
	if(document.form3.mat.value == "")
		{
			alert("Favor de escribir su matr�cula");
			document.form3.mat.focus();
		}
		else										
		{
			...
			{
				alert("Favor de seleccionar la hora para su reservaci�n.");
